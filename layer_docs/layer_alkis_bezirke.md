# Layer Definition: ALKIS Berlin Bezirke

Berliner Bezirksgrenzen, abgeleitet aus dem ALKIS Datenbestand

**Source**: https://gdi.berlin.de/services/wms/alkis_bezirke

**GetCapabilities**: https://gdi.berlin.de/services/wms/alkis_bezirke?service=WMS&request=GetCapabilities&version=1.3.0
...
|------------------|------------------|-----------|-------------|
| `bezirksgrenzen` | `alkis_bezirke` | Bezirksgrenzen | Berliner Bezirksgrenzen, abgeleitet aus dem ALKIS Datenbestand |
...
|-------|-------|--------|---------------|-------|
| `bezirksgrenzen` | `alkis_bezirke` | ✓ Valid | <img src="https://gdi.berlin.de/services/wms/alkis_bezirke?service=WMS&request=GetMap&version=1.3.0&layers=bezirksgrenzen&styles=alkis_bezirke&bbox=392000%2C5819000%2C394000%2C5821000&crs=EPSG%3A25833&width=256&height=256&format=image%2Fpng&transparent=true" width=200 alt="Preview (zoomed in): Bezirksgrenzen (alkis_bezirke)"> <img src="https://gdi.berlin.de/services/wms/alkis_bezirke?service=WMS&request=GetMap&version=1.3.0&layers=bezirksgrenzen&styles=alkis_bezirke&bbox=385000%2C5810000%2C400000%2C5825000&crs=EPSG%3A25833&width=256&height=256&format=image%2Fpng&transparent=true" width=200 alt="Preview (zoomed out): Bezirksgrenzen (alkis_bezirke)"> | [Preview with iD](https://ideditor-release.netlify.app/#background=custom:https%3A%2F%2Fgdi.berlin.de%2Fservices%2Fwms%2Falkis_bezirke%3Fservice%3DWMS%26request%3DGetMap%26version%3D1.3.0%26layers%3Dbezirksgrenzen%26styles%3Dalkis_bezirke%26format%3Dimage%2Fpng%26bbox%3D{bbox}%26crs%3D{proj}%26width%3D{width}%26height%3D{height}&disable_features=address_points,points,service_roads,paths,buildings,building_parts,indoor,landuse,boundaries,water,rail,pistes,aerialways,power,past_future,others&map=17.69/52.52133/13.40396&walkthrough=false) |
...
* `https://gdi.berlin.de/services/wms/alkis_bezirke?service=WMS&request=GetMap&version=1.3.0&layers=bezirksgrenzen&styles=alkis_bezirke&format=image/png&bbox={bbox}&crs={proj}&width={width}&height={height}` (Bezirksgrenzen)
